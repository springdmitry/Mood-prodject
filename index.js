...
const photoInputEl = document.getElementById("new-photoUrl-input")
const saveAccountCahngeBtnEl = document.getElementById("save-changes-btn")
...
settingsButtonEl.addEventListener("click", showAccountSettingsView)
saveAccountCahngeBtnEl.addEventListener("click", authUpdateProfile)
